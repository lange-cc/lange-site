...
if (!empty($val)) {
$data = json_decode($val);
$blognumber = $data->number;
}
?>
              <h3><?php echo $blognumber; ?></h3>

              <p>Total blog story</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
<?php
$val = $this->totalaccount;
if (!empty($val)) {
$data = json_decode($val);
$accountnumber = $data->number;
}
?>
              <h3><?php echo $accountnumber; ?></h3>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Site Visit Board</h3>
 ...
 <canvas id="chart-legend-normal"></canvas>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Unique Visitor Board</h3>
