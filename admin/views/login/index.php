...
<head>
  ...
  <title>Lange Admin | Log in</title>
  ...
  <div class="login-box-body">
    ...
    <form action="#" method="post" id="login-form">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-8">
          <a href="<?=LINK?>login/create/" class="btn btn-block btn-flat btn-create-account">Create account</a>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
        <br>
        <a href="<?=LINK?>login/remember/">Forget Password?</a>
        </div>
      </div>
    </form>
